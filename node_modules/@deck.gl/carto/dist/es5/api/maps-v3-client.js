...
function _getData() {
  _getData = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee7(_ref10) {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _core.log.deprecated('getData', 'fetchLayerData')();
...
function _fetchMapDataset2() {
  _fetchMapDataset2 = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(dataset, accessToken, credentials, clientId) {
    var connection, columns, geoColumn, source, type, _yield$_fetchDataUrl2, url, mapFormat, cache;

    return _regenerator.default.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            connection = dataset.connectionName, columns = dataset.columns, geoColumn = dataset.geoColumn, source = dataset.source, type = dataset.type;
            _context8.next = 3;
            return _fetchDataUrl({
...
function _fillInMapDatasets() {
  _fillInMapDatasets = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9(_ref11, clientId, credentials) {
...
function fetchMap(_x15) {
  return _fetchMap.apply(this, arguments);
}

function _fetchMap() {
  _fetchMap = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee11(_ref12) {
    var cartoMapId, clientId, credentials, autoRefresh, onNewData, defaultCredentials, localCreds, accessToken, url, map, stopAutoRefresh, intervalId;
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 12:
            ...
            if (autoRefresh) {
              intervalId = setInterval((0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10() {
                var changed;
          ...
          case 16:
            return _context11.abrupt("return", _objectSpread(_objectSpread({}, (0, _parseMap.parseMap)(map)), {
