...
var _cartoTileLayer = _interopRequireDefault(require("./carto-tile-layer"));
...
var CartoLayer = function (_CompositeLayer) {
  ...
  (0, _createClass2.default)(CartoLayer, [{
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                _context.next = 13;
                return (0, _api.fetchLayerData)(_objectSpread({
                  type: type,
                  source: source,
                  clientId: clientId,
                  credentials: credentials
    ...
    value: function _getSubLayerAndProps() {
      ...
      if (format === _mapsApiCommon.FORMATS.TILEJSON) {
        var tileUrl = new URL(data.tiles[0]);
        props.formatTiles = props.formatTiles || tileUrl.searchParams.get('formatTiles') || _mapsApiCommon.TILE_FORMATS.MVT;
        return props.formatTiles === _mapsApiCommon.TILE_FORMATS.MVT ? [_geoLayers.MVTLayer, props] : [_cartoTileLayer.default, props];
      }

      return [_layers.GeoJsonLayer, props];
    }
  }, {
    key: "renderLayers",
