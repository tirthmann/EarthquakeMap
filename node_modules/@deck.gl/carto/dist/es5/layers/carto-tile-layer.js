...
function parsePbf(buffer) {
  ...
  var tile = _cartoTile.Tile.read(pbf);
...
var CartoTileLayer = function (_MVTLayer) {
  ...
  (0, _createClass2.default)(CartoTileLayer, [{
    ...
    value: function renderSubLayers(props) {
      ...
      props.extensions = [new _extensions.ClipExtension()].concat((0, _toConsumableArray2.default)(props.extensions || []));
      props.clipBounds = [west, south, east, north];
      var subLayer = new _layers.GeoJsonLayer(_objectSpread({}, props));
      return subLayer;
    }
  }]);
