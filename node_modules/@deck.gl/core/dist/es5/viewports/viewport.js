...
var Viewport = function () {
  ...
  (0, _createClass2.default)(Viewport, [{
    ...
    value: function _getCenterInWorld(_ref5) {
      ...
      var center = new _core.Vector3(this.projectPosition([longitude, latitude, 0]));

      if (meterOffset) {
        var commonPosition = new _core.Vector3(meterOffset).scale(distanceScales.unitsPerMeter);
